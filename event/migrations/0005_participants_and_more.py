# Generated by Django 4.1 on 2023-02-06 10:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='event',
            constraint=models.CheckConstraint(check=models.Q(('evt_date__gte', datetime.datetime(2023, 2, 6, 11, 28, 45, 740716))), name='Please check out the event date'),
        ),
        migrations.AddField(
